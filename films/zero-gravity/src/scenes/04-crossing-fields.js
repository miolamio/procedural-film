// 04 crossing-fields — Fields pass through (scenario S05_04). T 66.105 to 93.534 (bars 38–53).
// Each body emits concentric rings, A on the beats and B on the off-beat 8ths; they cross in a moire band.
// Layers: WORLD.drawAll (fields are a world layer from this shot on; the centre glyph flickers and loses dots).
(function () {
  'use strict';
  const FILM = window.FILM;
  const ID = 'crossing-fields';
