// Fixture timeline for testing the tools (not the film). 20 seconds.
// Palette holds 8..18 so this branch stays gap-free while fx-branch keeps its reserved slot.
FILM.TIMELINE = {
  title: 'fixture',
  bpm: 120,
  duration: 20,
  shots: [
    ...
    { id: 'palette', file: '04-palette-sheet.js', start: 6, end: 18, mode: 'illustrated', brief: 'Every name in lib.pal as a labelled swatch, on paper above and blueprint below.' },
