...
- **The counter** (recipe 53) runs in frames towards midnight, `HH:MM:SS:FF`, stepping a drawing at a time; in the fixture it reads `00:00:00:00` on the cut to plate B. Dead air is a time as much as a place.
